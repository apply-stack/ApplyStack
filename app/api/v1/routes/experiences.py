# Authenticated experience source records reusable across multiple CVs.
...
# Return paginated experiences owned by the authenticated account.
# Use a deterministic date-based order with an ID tie-breaker.


# POST /api/v1/me/experiences
# Create a source experience with company_name, position_title, and optional location.
...
# GET /api/v1/me/experiences/{experience_id}
# Return the owned experience and its complete editable source data.
# Include ordered description bullets.


# PATCH /api/v1/me/experiences/{experience_id}
# Update provided experience fields while preserving omitted values.
# Validate the final date range after merging the patch with stored data.
# Existing CV snapshots remain unchanged.


# DELETE /api/v1/me/experiences/{experience_id}
# Physically delete the owned experience only when foreign-key rules allow deletion.
...
# POST /api/v1/me/experiences/{experience_id}/bullets
...
# PATCH /api/v1/me/experiences/{experience_id}/bullets/{bullet_id}
...
# DELETE /api/v1/me/experiences/{experience_id}/bullets/{bullet_id}
...
# PUT /api/v1/me/experiences/{experience_id}/bullets/order
